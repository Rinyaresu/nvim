...
- [ruby](https://www.ruby-lang.org/en/). Ruby runtime. Required by the solargraph.
...
- (optional) [tmux](https://github.com/tmux/tmux). Tmux is a terminal multiplexer.
- (optional) [ltex-ls](https://github.com/valentjn/ltex-ls). Ltex ls (Ltex Language Server) implements a language server
